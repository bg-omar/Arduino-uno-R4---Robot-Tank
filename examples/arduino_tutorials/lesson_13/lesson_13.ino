...
IRrecv irrecv(A2);  //set IRrecv irrecv to A0
...
#define SCL_Pin  5  //Set clock pin to A5
#define SDA_Pin  4  //Set data pin to A4
...
#define servoPinZ 10 //pin of servo
...
void setup(){
  ...
  procedure(servoPin, 90);  //Servo rotates to 90° 
  procedure(servoPinZ, 0);  //Servo rotates to 90°
}
...
void loop(){
  ...
  {
          procedure(servoPin, 160);  //Servo rotates to 90° 
  ...
  {
             procedure(servoPin, 20);  //Servo rotates to 90° 
     procedure(servoPinZ, 30);
    Car_T_right();
